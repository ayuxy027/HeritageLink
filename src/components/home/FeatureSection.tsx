  ...
  const features: Feature[] = [
    {
      ...
      description:
        'Book tickets instantly with our online payment gateway, eliminating long queues and change issues.',
    },
    {
      icon: FaQrcode,
      title: 'Unique QR Code Entry',
      description:
        'Receive a personalized QR code upon booking for swift, contactless entry to the heritage site.',
    },
    {
      icon: FaLanguage,
      title: 'Multilingual Support',
      description:
        'Our chatbot communicates in multiple languages, ensuring a seamless experience for international visitors.',
    },
    {
      icon: FaRobot,
      title: 'AI Support',
      description:
        'Experience 24/7 intelligent assistance with our advanced AI, providing personalized recommendations and answering queries instantly.',
    },
  ];
...
const FeatureCard = ({ feature, index }: FeatureCardProps): React.JSX.Element => {
  ...
  return (
    ...
    >
      <div className="absolute top-0 right-0 w-24 h-24 transform translate-x-8 -translate-y-8 rounded-full bg-proj opacity-10" />
      <motion.div
