...
function EventCard({ event }: { event: EventItem }): React.JSX.Element {
    ...
    >
      <div className="flex-grow p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          >
            <EventIcon size={32} className="text-blue-500" aria-hidden="true" />
          </motion.div>
          <Link
            to="/book"
          ...
          >
            <Ticket className="mr-2" size={16} aria-hidden="true" />
            Book Now
          </Link>
        </div>
        ...
        <div className="mb-4 space-y-2">
          <p className="flex items-center text-sm text-gray-600">
            <Calendar className="mr-2 text-blue-500" size={16} aria-hidden="true" />
            {event.date}
          </p>
          <p className="flex items-center text-sm text-gray-600">
            <Clock className="mr-2 text-blue-500" size={16} aria-hidden="true" />
            {event.time}
          </p>
          <p className="flex items-center text-sm text-gray-600">
            <MapPin className="mr-2 text-blue-500" size={16} aria-hidden="true" />
            {event.location}
          </p>
        </div>
