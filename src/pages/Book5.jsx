...
const Book5 = () => {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen py-12 bg-gray-50 font-body">
      ...
      >
        <motion.h1 
          className="mb-8 text-3xl font-bold text-center text-transparent bg-proj bg-clip-text"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <motion.button
            ...
            className="w-full px-4 py-3 text-sm font-medium rounded-md text-proj bg-proj bg-opacity-10 hover:bg-opacity-20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-proj"
            variants={scaleIn}
        ...
        <div className="flex justify-between mt-8">
          <motion.button 
            ...
            className="flex items-center justify-center px-6 py-3 text-sm font-medium transition duration-300 bg-white border-2 rounded-lg text-proj border-proj hover:bg-proj hover:text-white focus:outline-none focus:ring-2 focus:ring-proj focus:ring-offset-2"
            variants={scaleIn}
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.97 }}
          >
          ...
          <motion.button 
            ...
            className="flex items-center justify-center px-6 py-3 text-sm font-medium text-white transition duration-300 rounded-lg bg-proj hover:bg-proj-hover focus:outline-none focus:ring-2 focus:ring-proj focus:ring-offset-2"
            variants={scaleIn}
            whileHover={{ scale: 1.03 }}
            whileTap={{ scale: 0.97 }}
          >
