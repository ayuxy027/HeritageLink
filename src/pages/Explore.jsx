...
import { Search, MapPin, Calendar, Clock, ChevronRight, ChevronDown, Filter } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-7xl px-4 mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-center mb-8 space-y-4 sm:space-y-0 sm:space-x-4">
          ...
          <div className="relative w-full sm:w-auto">
            ...
            <ChevronDown className="absolute w-5 h-5 text-gray-400 transform -translate-y-1/2 right-3 top-1/2 pointer-events-none" />
          </div>
          ...
          <div className="relative w-full sm:w-auto">
            ...
            <Calendar className="absolute w-5 h-5 text-gray-400 transform -translate-y-1/2 right-3 top-1/2 pointer-events-none" />
            {isCalendarOpen && (
    ...
    >
      ...
      <div className="p-6 mt-auto">
        <div className="flex items-center justify-between">
          ...
          <button className="px-7 py-4 text-sm font-medium text-white transition-colors duration-300 rounded-full bg-proj hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            Book Now
          </button>
        </div>
      </div>
